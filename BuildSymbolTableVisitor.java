...
public class BuildSymbolTableVisitor implements Visitor {
  ...
  public void visit(ClassDeclSimple n) {
    ...
    if(currentNode.getData().containsKey(n.i.s)){
		System.err.println("Multiply defined class identifier " + n.i.s + " at line ");
	}
	...
	for(int i = 0; i < n.ml.size(); i++){
		if(currentNode.parentsContains(n.ml.elementAt(i).i.s)){
			System.err.println("Multiply defined identifier " + n.ml.elementAt(i).i.s + " at line ");
		}
  ...
  public void visit(Call n) {
	...
	if(node == null){
		if(!currentNode.parentsContains(n.i.s)) System.err.println("Use of undefined identifier " + n.i.s + " at line ");
	}
    n.i.accept(this);
  ...
  public void visit(IdentifierExp n) {
	if(!currentNode.parentsContains(n.s)){
		System.err.println("Use of undefined identifier " + n.s + " at line ");
	}
	expStr = n.s;
  }
